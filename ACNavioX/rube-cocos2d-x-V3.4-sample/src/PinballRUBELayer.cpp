...
Point PinballRUBELayer::initialWorldOffset()
{
...
void PinballRUBELayer::draw(Renderer *renderer, const cocos2d::Mat4& transform, bool transformUpdated)
{
    //don't do debug draw
}
...
void PinballRUBELayer::onTouchesBegan(const std::vector<cocos2d::Touch*>& touches, cocos2d::Event *event)
{
...
// notice that we are not overriding TouchesMoved, so you can zoom and pan the layer :)
...
void PinballRUBELayer::onTouchesEnded(const std::vector<cocos2d::Touch*>& touches, cocos2d::Event *event)
{
